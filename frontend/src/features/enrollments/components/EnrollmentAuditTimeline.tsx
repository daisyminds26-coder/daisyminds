...
import { useAuditLog } from '@/features/enrollments/hooks/use-audit-log'
...
export function EnrollmentAuditTimeline({
  enrollmentId,
  page,
  onPageChange,
}: {
  ...
  const auditLogQuery = useAuditLog(enrollmentId, page)

...
import type { ProfileCompletionStatus } from '@/features/trainers/types'
...
/** Server-calculated (trainer-management.service.ts#calculateProfileCompletion) — never editable from here. */
